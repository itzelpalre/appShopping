...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>App Shopping | Itzel Palma Reyes</title>
    ...
    <body class="antialiased">
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
            ...
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8" style="display: flex; align-items: center;">
               <!--Accesos-->
               @if (Route::has('login'))
                <div class="container text-center" style="background-color: #ffdd2f; padding: 15px 30px; height: auto;">
                    ...
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                <input id="password" type="password" style="border: 1px solid;" placeholder="Password" class="form-control @error('password') is-invalid @enderror" name="password" required autocomplete="current-password">
